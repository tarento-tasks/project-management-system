...
public class ProjectService {
    ...
    @Transactional
    public ApiResponse<ProjectDTO> saveOrUpdateProject(Optional<UUID> projectId, ProjectDTO projectDTO) {
        ...
        return new ApiResponse<>(HttpStatus.OK.value(), "Project saved successfully", convertToDTO(projectRepository.save(project)));
    }

    @Transactional
    public ApiResponse<Object> deleteProject(UUID id) {
